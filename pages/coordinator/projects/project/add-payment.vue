  ...
  methods: {
    async savePayment() {
      ...
      const createPaymentInput = {
        supportPlanId: this.$store.state.coordinator.selectedSupportPlan.id,
        ...
        primaryForeignCurrency: this.primaryForeignCurrency.split(' ')[0],
        ...
        secondaryForeignCurrency: this.secondaryForeignCurrency.split(' ')[0],
        ...
        ), // todo: add a for the amount vs the supportPlan totalFund amount
